...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page-hero { background: linear-gradient(135deg, #1e3a5f 0%, #2d5a87 100%); color: #fff; padding: 2.5rem 0 2rem; }
    ...
    .brand-body { padding: 2rem 0 1rem; }
...
${suppliedPartsExtraCss}
    ...
    .section-contact { padding: 1rem 0 3rem; }
      ...
      <div class="contact-layout">
        ...
        <div class="contact-form-wrap">
          ...
          <div class="contact-iframe-wrap" id="iframeContainer">
            <div id="iframePlaceholder" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 600px; background: linear-gradient(135deg, #f0f6fb 0%, #e8f2f9 100%); border: 2px solid #dce8f4; border-radius: 10px; text-align: center; padding: 2rem;">
            ...
            <iframe id="contactFormIframe" data-src="https://erp.abcspareparts.eu/lead-request/new" data-i18n-title="contact_iframe_title" title="${escapeAttr(d.contact_iframe_title)}" style="display: none; border: none; width: 100%; min-height: 600px;"></iframe>
          </div>
        </div>
      </div>
    </div>
